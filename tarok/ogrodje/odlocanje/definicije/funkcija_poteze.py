...
class FunkcijaPoteze:
    def __init__(self,
                 funkcija: Callable[[List[Igralec], List[List[Tuple[Igralec, Karta]]], List[Karta], int, Set[Karta], Set[Karta]], Karta]
                 ) -> None:
    ...
    def izracunaj(self,
        ...
        pred njim.
        :param vzeto_iz_talona: karte, ki jih je aktivni igralec vzel iz talona
        :param id_igralca:
        ...
        """
        return self.funkcija(postavitev_igralcev, dosedanje_poteze, vzeto_iz_talona, id_igralca, vse_karte_igralca, dovoljene_karte_igralca)